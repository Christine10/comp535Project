...
jCBList = h.AvailableTraj(index_straj).jCBList;
 ...
 labels = {};
 index = 0;
 list_colors = {'[0, 0, 1]','[0, 0.5, 0]','[1, 0, 0]','[0.75, 0, 0.75]','[0.75, 0.75, 0]','[0.25, 0.25, 0.25]'};
 ...
 for iestimator = list_estimators
     ...
     line(iestimator.error(:,1),iestimator.error(:,2),'Parent',axes_error,'Color',color,'LineWidth', 2)
     
     line(iestimator.ecdf.B,iestimator.ecdf.A,'Parent',axes_ecdf,'Color',color,'LineWidth', 2)
